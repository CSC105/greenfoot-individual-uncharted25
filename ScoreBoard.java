...
public class ScoreBoard extends Actor
{
    ...
    {
        getImage().drawImage(new GreenfootImage(text, height, color, greenfoot.Color.WHITE), x, y);
    }
    ...
    private void drawScores()
    {
        ...
        drawString("Score", 100, topSpace - HEADER_TEXT_HEIGHT - 5, MAIN_COLOR, HEADER_TEXT_HEIGHT);
        drawString("Life", 100 + getImage().getWidth() / 2, topSpace - HEADER_TEXT_HEIGHT - 5, MAIN_COLOR, HEADER_TEXT_HEIGHT);        
